...
<div id="right-panel" class="right-panel">
    ...
    <div {if ProfilTable::getMessageErreur() neq ""} class="alert alert-danger" {elseif ProfilTable::getMessageSucces() neq ""} class="alert alert-success" {/if}>
        {if ProfilTable::getMessageErreur() eq ""}
                    ...
                    <div class="card">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"><strong>{$unProfil->getMontant()}</strong> €</p>
                            </div>
                        </div>
                    </div>
                </div>
