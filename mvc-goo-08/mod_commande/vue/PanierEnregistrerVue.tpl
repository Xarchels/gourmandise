                        ...
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <div class="form-group">Date de commande :</div>
                                    <div class="form-group">Client :</div>
                                    <div class="form-group">
                                        Vendeur : {$uneCommande->getcodev()}
                                        - {$uneCommande->getVendeurPrenom()} {$uneCommande->getVendeurNom()}
                                    </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    ...
                                    <div class="form-group">Total TVA : {$uneCommande->getTotal_tva()}</div>
                                </div>
