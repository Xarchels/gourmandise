...
function content_6239ef30c748f7_77165215 (Smarty_Internal_Template $_smarty_tpl) {
...
">
                                    <?php if ($_smarty_tpl->tpl_vars['action']->value != 'ajouter') {?>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="reference" value="<?php echo $_smarty_tpl->tpl_vars['unProduit']->value->getReference();?>
"
                                                   readonly>
                                        </div>
                                    <?php }?>
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="designation" value="<?php echo $_smarty_tpl->tpl_vars['unProduit']->value->getDesignation();?>
"
...
>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="descriptif" value="<?php echo $_smarty_tpl->tpl_vars['unProduit']->value->getDescriptif();?>
"
                                                <?php echo $_smarty_tpl->tpl_vars['readonly']->value;?>
>
                                    </div>
...
</strong> est actuellement en position <strong><?php echo $_smarty_tpl->tpl_vars['unProduit']->value->getPlace();?>
</strong> parmi les meilleures ventes</p>
                            </div>
                        </div>
                    </div>
                </div>
